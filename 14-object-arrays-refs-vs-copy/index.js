...
let age = 100
let age2 = age
console.log('original age and age2:', age, age2)
age = 200
console.log('after change: age and age2:', age, age2)

let icon = 'Liberty'
let icon2 = icon
console.log('original icon and icon2:', icon, icon2)
icon = 'Lady'
console.log('after change: icon and icon2:', icon, icon2)
...
// COPY: another way of creating a copy of the original array: concatenates all of the items into the empty array
...
// REFERENCE: captain is NOT the array - it's just a REFERENCE to the original person object, so you get BOTH objects updated:
